...
$sql_show_tasks="SELECT * FROM tasks WHERE user_id=? AND complete=1";
...
<div class="container mx-auto mt-8 max-w-2xl px-4">
  ...
  <div class="flex justify-center space-x-4 mb-6">
    ...
    <a href="./PendingTasks.php" class="px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300">Pending</a>
